/*
 * Rich Presence Pro Tanki for Discord 
 * Rich Presence for Discord based on the famous and nostalgic tank game, Pro Tanki Online!
 * Author: Discord: floattt_ Github: (brunosantosss)
 * License: MIT License
 * Created on: July 20, 2024
 * 
 * This project uses the DiscordRPC library to connect to Discord and 
 * update the Rich Presence based on the execution of the ProTanki.exe process.
 *
 * Requirements:
 * - .NET 6.0 or higher
 * - DiscordRPC library
